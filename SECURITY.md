...
Cricket Intelligence API is maintained as a portfolio project and A Chroma server, local helper, or provider credentials may be needed for enhanced retrieval; the current regression assertion is unresolved.
